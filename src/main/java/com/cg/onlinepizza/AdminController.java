...
public class AdminController {
	...
	public ResponseEntity<Pizza> getPizzaListById(@PathVariable int id) throws PizzaIdNotFoundException {
	  ...
	  @GetMapping("/orders") public ResponseEntity<List<Order>> viewOrder() throws
	  OrderIdNotFoundException {
	  
	  List<Order> order = orderService.getOrders(); return new
	  ResponseEntity<List<Order>>(order, HttpStatus.OK); }
	  
	 
	
	  @GetMapping("/orders/{id}") public ResponseEntity<Order>
	  getOrder(@PathVariable int id) throws OrderIdNotFoundException {
