...
public class PizzaController {
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<?> deletePizza(@PathVariable int id) throws PizzaIdNotFoundException {
	...
	@GetMapping({"/type/{pizzaType}","/admin/type/{pizzaType}"})
	...
	@GetMapping({"/name/{pizzaType}","/admin/name/{pizzaType}"})
