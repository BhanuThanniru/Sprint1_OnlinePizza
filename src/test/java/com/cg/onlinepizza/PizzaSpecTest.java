...
class PizzaSpecTest {
	...
	public void addPizza() {
		 ...
		 */
		 ...
		 pizza3.setPizzaId(2);
		 pizza3.setPizzaName("Paneer");
		  pizza3.setPizzaType("Paneer");
		  pizza3.setPizzaDescription("Too Yummy");
		  map2.put("Medium", 350);
		  map2.put("Regular", 400); 
		  map2.put("Large", 450);
		  pizza3.setMap1(map2);
	...
	public void updatePizza() { 
		Pizza pizza = repo.updatePizza(1, "Tandoori Pizza");
		Pizza pizza4= new Pizza(9, "Tandoori", "Tandoori Pizza", "Too Yummy");
	...
	public void deletePizza() throws PizzaIdNotFoundException
	{
		...
		pizz= repo.deletePizza(9);
		assertEquals( pizz.getPizzaName(),null, () -> "Pizza deleted...");
	}

	@Test
	public void viewPizza() throws PizzaIdNotFoundException {

		Pizza pizza = new Pizza();
		pizza = repo.viewPizza(1); //viewing pizza by id
		
		Pizza pizza3 = new Pizza(1, "Paneer", "Paneer","Too Yummy");
		
		assertEquals(pizza.getPizzaName(),pizza3.getPizzaName(),()-> "Pizza names must match");

	}

	@Test
	public void viewPizzaList() {

		List<Pizza> list = new ArrayList<Pizza>();
		list = repo.viewPizzaList();
