...
class CoupanSpec {
	...
	void addCoupantest() {
	 ...
	 Coupan c1= new Coupan(12, "Swiggy", "Festival Offer","iop");
	 Coupan c2= new Coupan(12, "Swiggy", "Festival Offer","iop");
	 repo.addCoupans(c2);
	...
	@Test 
	void editCoupan() throws InvalidCoupanOperationException {
		  
		  Coupan c2=new Coupan(12, "Zomato", "Festival Offer","iop"); 
		  repo.editCoupans(c2);
		  
		  assertEquals("Zomato",c2.getCoupanName(),()->"Object should return the same name");
	}
       ...
       @Test 
		void delCoupan() throws CoupanIdNotFoundException {
		...
		assertNull(coupandeleted);
		 ...
		 @Test
     void AllCoupan() { 
		Coupan c5=new Coupan(98, "Domino","IPL Offer","30% offer pay through via Paytym"); 
		Coupan c7=new Coupan(100, "PizzaHut", "Weekend Offer","30% offer pay through via Phonepay"); 
	    Coupan c8 =new Coupan(105, "Uber","CCL Offer","30% offer pay through via Icici debit card");
	  ...
	  List<Coupan> list1=new ArrayList<Coupan>(); 
	  list1.add(c5); 
	  list1.add(c7);
	  list1.add(c8);
