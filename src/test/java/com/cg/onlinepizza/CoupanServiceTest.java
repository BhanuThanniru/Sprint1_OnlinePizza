...
public class CoupanServiceTest {
    ...
    public void getCoupanByIdTest() throws CoupanIdNotFoundException
    {
		  ...
		  assertEquals("Swiggy",  coupanService.listCoupanById(12).get().getName());
				  //pizzaService.getPizzaById(1).getName());
		  
		  //Exception exception = assertThrows(PizzaIdNotFoundException.class, () -> pizzaService.getPizzaById(1));
		  //assertFalse(exception.getMessage().contains("Pizza Id Not Found"));
